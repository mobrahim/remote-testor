...
WildCat is an "infrastructure" to easily write fully automated tests to install/deploy full applications.
...
to regularly copy scripts maintained in SVN to a number of environments, run JUnit tests from system
installation up to front-end web tests there, and fetch results back.

WildCat per-se is NOT specific to OCS, although that is what it is first used for.  


How it works - high-level
-------------------------

build-central.xml is called on a central machine (Hudson build server)
